...
A) You don't have to at all. While my card does give far greater access to internal physics information, it is not impossible to derive most of these values using the existing drivers.
***However, this is an addon for Sable, not Aeronautics!*** While the two will likely be used together, others can use Sable without Aeronautics at all!